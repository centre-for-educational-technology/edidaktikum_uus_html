...
function smart_height100_perc() {
    if (jQuery(window).width() < 900) {
        jQuery('.height_100percent').css({
            'min-height': jQuery(window).height() - jQuery('.main_header').height() - jQuery('.footer').height() - jQuery('#wpadminbar').height() + 'px'
        });
    } else {
        jQuery('.height_100percent').css({
            'min-height': jQuery(window).height() - jQuery('.footer').height() - jQuery('#wpadminbar').height() + 'px'
        });
    }
}
...
function smart_fw_block() {
    ...
    if (div_tag.hasClass('right-sidebar') || div_tag.hasClass('left-sidebar')) {} else {
